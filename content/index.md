...
欢迎来到这个已经配置好的 Quartz demo。这里是入口页，左侧可以浏览文件夹，右上可以搜索，右侧会显示图谱、目录和反向链接。
...
- [[projects/demo-roadmap|Demo Roadmap]]：一个更像项目文档的页面。

## 一条快速链路

这个主页链接到 [[notes/hello-quartz]]，那篇文章又会链接回来。打开右侧 Graph 或 Backlinks，就能看到 Quartz 自动生成的关系。

> [!tip]
> 以后你只需要把 Markdown 文件放进 `content/`，Quartz 就会把它们构建成静态网站。
